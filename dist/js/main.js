...
var _lazysizes = __webpack_require__(7);
...
var Site = function () {
  ...
  _createClass(Site, [{
    ...
    value: function toggleScrollLock() {
      var $main = (0, _jquery2.default)('#main-container');
      if ($main.hasClass('scroll-locked')) {
        $main.removeClass('scroll-locked').css('top', 'unset');
        (0, _jquery2.default)(window).scrollTop(this.lockOffset);
      } else {
        this.lockOffset = (0, _jquery2.default)(window).scrollTop();
    ...
    value: function setupSwiper() {
      var _this = this;
      var $swiperContainer = (0, _jquery2.default)('.swiper-container');
      ...
      var swiperArgs = {
        ...
        on: {
          slideChangeTransitionEnd: function slideChangeTransitionEnd() {
            (0, _jquery2.default)('.swiper-slide.zoomed').removeClass('zoomed');
            (0, _jquery2.default)('.slide-caption.show-info').removeClass('show-info');
          }
        }
      };

      var swiperInstance = new _swiper2.default('.swiper-container', swiperArgs);

      (0, _jquery2.default)('.toggle-overlay').on('click', function (event) {
        _this.toggleScrollLock();

        var $target = (0, _jquery2.default)(event.target);
        (0, _jquery2.default)('#overlay-gallery').toggleClass('active');
        (0, _jquery2.default)('.swiper-slide.zoomed').removeClass('zoomed');
        if ($target.hasClass('gallery-thumb')) {
          var id = $target.attr('data-id');
          var index = parseInt((0, _jquery2.default)('.swiper-slide[data-image-id="' + id + '"]').attr('data-swiper-slide-index'));
      ...
      (0, _jquery2.default)('.slide-caption-info-trigger').on('click', function (event) {
        var $caption = (0, _jquery2.default)(event.target).parent('.slide-caption');
...
var _ssrWindow = __webpack_require__(6);
